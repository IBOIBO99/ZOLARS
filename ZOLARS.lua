------------------------------------------------
-- This Source Was Developed By (Y.L) @IBOIBO100.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1432584666,1432584666}
ZOLARS = Config.ZOLARS
TokenBot = Config.TokenBot
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'ايبو')
--     Source dev-yousef     --
...
FilesPrint = FilesPrint.."\27[35m".."• • • • • • 𝙄𝘽𝙊 • • • • • • ≈ ┉ ≈ ┉\n".."\27[m"
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
...
admins = 'االادامن • ' else admins = '' end
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
✯╽م6 ⤶ اوامر الاعضاء
• • • • • • 𝙄𝘽𝙊 • • • • • •
✯╽[𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍](https://t.me/HH_418)
]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
✯╽حذف ردود الرتب
• • • • • • 𝙄𝘽𝙊 • • • • • •
✯╽تغيير الايدي ⤶ لتغيير الكليشة
✯╽تعيين الايدي ⤶ لتعيين الكليشة
✯╽حذف الايدي ⤶ لحذف الكليشة
• • • • • • 𝙄𝘽𝙊 • • • • • •
✯╽تفعيل • تعطيل + الامر ⤶ ⤹
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
• • • • • • 𝙄𝘽𝙊 • • • • • •
✯╽تنزيل الكل
✯╽الميديا • امسح - تفعيل امسح تعطيل امسح
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="• رجوع •",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌁ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
if text and text:match('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "ايبو")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(ZOLARS..'Abs:NameBot') or "ايبو")..' ','')
end
...
local key = {
{'وضع اسم البوت','⤶ تحديث ⌁','وضع كليشة المطور'},
{'⤶ المطورين ⌁','⤶ الاحصائيات ⌁'},
...
Start_Source = "✯╽مرحبا انا بوت اسمي "..NameBot.."\n✯╽اختصاصي حماية المجموعات\n✯╽من التفليش والسبام والخخ .. . ،\n✯╽تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ⤶ تفعيل\n✯╽سيتم رفع االادامن والمنشئ تلقائيا"
end 
...
if SecondSudo(msg) then
if text == 'تعيين رد الخاص' or text == 'ضع كليشة ستارت' or text == '⤶ تعيين رد الخاص ⌁' then 
DevAbs:set(ZOLARS..'Abs:Start:Bots'..msg.sender_user_id_,true) 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
if text == 'حذف رد الخاص' or text == 'حذف كليشة ستارت' or text == '⤶ حذف رد الخاص ⌁' then 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽عدد اعضاء المجموعة اقل من ⤶ *'..(DevAbs:get(ZOLARS..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
local BotName = (DevAbs:get(ZOLARS.."Abs:NameBot") or 'ايبو')
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..ZOLARS..'.json', '✯╽يحتوي الملف على ⤶ '..#List..' مجموعة',dl_cb, nil)
...
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'ايبو') 
local ZOLARSTEAM = {"اسمي الجميل "..NameBot.." 😚♥️","هلاا يا روحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM[math.random(#ZOLARSTEAM)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(ZOLARS..'Abs:NameBot') or 'ايبو') then 
NameBot = (DevAbs:get(ZOLARS..'Abs:NameBot') or 'ايبو')
local ZOLARSTEAM = {'😸♥️ هلا قلبي وياك '..NameBot..' تفضل','تراك طفشتني 😕😒💔','لك عيني وقلبي '..NameBot..' 😻♥️','روح روح نام 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM[math.random(#ZOLARSTEAM)] , 1, 'html') 
return false 
end
...
{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}},
}
...
--     Source dev-yousef     --
if text == 'رفع المشرفين' and ChCheck(msg) or text == 'رفع االادامن' and ChCheck(msg) then  
...
if num == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯╽لا يوجد الادمن ليتم رفعهم\n✯╽تم رفع مالك المجموعة", 1, 'md')
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽تم رفع '..num..' من االادامن \n✯╽تم رفع مالك المجموعة', 1, 'md')
end
end,nil) 
end
--     Source dev-yousef     --
...
Text = [[
Welcome To Source
𓄇[˛ ch .](https://t.me/HH_418)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌔ Source Channel',url="https://t.me/HH_418"}},
{{text = '⌔ Developer',url="t.me/IBOIBO100"},{text = '⌔ تواصل',url="https://t.me/IBOIBO100"}},{{text= '⌔ Support Source .',url="https://t.me/HH_418"}}
}
local msg_id = msg.id_/2097152/0.5
...
Text = "• *The developer and programmer of this source is* : [MaLaTH Al DleM](https://t.me/IBOIBO100)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- 𝗆𝖺𝗅𝖺𝗍𝗁 𝖺𝗅 𝖽𝗅𝖾𝗆 .',url="t.me/IBOIBO100"}}}
local msg_id = msg.id_/2097152/0.5
...
Dev_Abs(msg.chat_id_, msg.id_, 1, 'هذا تاج راسك يا غبي؟😏🖕🏿', 1, 'md') 
return false  
end  
...
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = { "غبي @"..username.." احترم اسيادك لا أمسح بيك الأرض","انطم يا فاشل @"..username.." خليك محترم لا ألبلعك التراب، 😖👌🏿","حبيبي @"..username.." راح احترمك هذي المرة بس، 🤔🔪","ماشيلك @"..username.." خليك منبوذ يا غبي 😏🖕🏿","في الحسينيات كلب وهنا سيد @"..username.." المجنون لا تكلمه ولا تخليه يتكلم😒🔪",}
...
local ZOLARSTEAM = "صار صار 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = {"غبي احترم اسيادك لا أمسح بيك الأرض","هشش فاشل خليك محترم لا ألبلعك التراب، 😖👌🏿","ماشيلك خليك منبوذ يا غبي 😏🖕🏿","في الحسينيات كلب وهنا سيد المجنون لا تكلمه ولا تخليه يتكلم😒🔪","حبيبي راح احترمك هذي المرة بس، 🤔🔪"} 
...
local ZOLARSTEAM = "صار صار 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,ZOLARSTEAM, 1, 'md') 
local ZOLARSTEAM = {"تتعال ححب محتاجيك🙂🍭","ايش معاك تتأخر ؟؟؟؟؟؟😒🔪","تعال بسرعة نبيك🤕♥️","تعااال لنا ساعة نناديك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..ZOLARSTEAM[math.random(#ZOLARSTEAM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
adminall = 'االادامن العامين • ' else adminall = '' end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✯╽تم رفعه في قائمة االادامن العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
end end
...
ReplyStatus(msg,result.id_,"Reply","✯╽تم رفعه في قائمة االادامن العامين")  
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✯╽تم رفعه في قائمة االادامن العامين")  
end
--     Source dev-yousef     --
--      Rem adminall      --
...
function prom_reply(extra, result, success)
DevAbs:srem(ZOLARS..'Abs:AdminAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✯╽تم تنزيله من قائمة االادامن العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevAbs:srem(ZOLARS..'Abs:AdminAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✯╽تم تنزيله من قائمة االادامن العامين")  
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✯╽تم تنزيله من قائمة االادامن العامين")  
end end
--     Source dev-yousef     --
--       Set Vipall       --
...
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✯╽تم رفعه في قائمة االادامن")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevAbs:sadd(ZOLARS..'Abs:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✯╽تم رفعه في قائمة االادامن")  
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✯╽تم رفعه في قائمة االادامن")  
end
--     Source dev-yousef     --
--        Rem admin       --
...
function prom_reply(extra, result, success)
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✯╽تم تنزيله من قائمة االادامن")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) > 0 then
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
end end
...
if result.id_ then
DevAbs:srem(ZOLARS..'Abs:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✯╽تم تنزيله من قائمة االادامن")  
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✯╽تم تنزيله من قائمة االادامن")  
end end
--     Source dev-yousef     --
--       Set Vipmem       --
if Admin(msg) then
...
local Text = '✯╽قم باستعمال الازرار لرفع العضو ⤶ ⤹\n✯╽العضو ⤶ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
end
...
local Text = '✯╽قم باستعمال الازرار لتنزيل العضو ⤶ ⤹\n✯╽العضو ⤶ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'zzzii')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '˛ 𝘿𝙀𝙑 𝙄𝘽𝙊𝙄𝘽𝙊 ✯ .',url="t.me/HH_418"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
ZOLARSTEAM = {"ها هلاو","انطق","قول حبي","تفضل"};
...
--     Source dev-yousef     --
if Manager(msg) then
if text == "االادامن" and ChCheck(msg) or text == "الادمنية" and ChCheck(msg) then 
...
--     Source dev-yousef     -- 
if text == "االادامن العامين" and ChCheck(msg) then 
local abs =  'Abs:AdminAll:'
local List = DevAbs:smembers(ZOLARS..abs)
text = "✯╽قائمة االادامن العامين ⤶ ⤹ \n• • • • • • 𝙄𝘽𝙊 • • • • • •\n"
for k,v in pairs(List) do
local username = DevAbs:get(ZOLARS..'Save:UserName'..v)
if username then
text = text..k.."~ : [@"..username.."]\n"
...
sudobot = '\n✯╽عدد القروبات ⤶ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n✯╽عدد القروبات ⤶ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n✯╽عدد القروبات ⤶ '..(DevAbs:get(ZOLARS..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'✯╽عدد القروبات الان ⤶ { '..#group..' }'..ZOLARSgp1..ZOLARSgp2..'\n✯╽العدد الحقيقي الان  ⤶ ( '..ZOLARSgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽الالدردشة بالفعل مقفلة في المجموعة', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽الالدردشة بالفعل مفتوحة في المجموعة', 1, 'md')
end
end
...
if SudoBot(msg) then
if txts[2] == 'االادامن العامين' or txts[2] == 'االادامن العام' or txtss[2] == 'االادامن العامين' or txtss[2] == 'االادامن العام' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯╽تم حذف االادامن العامين")  
...
if Manager(msg) then
if txts[2] == 'االادامن' or txtss[2] == 'االادامن' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✯╽تم حذف االادامن")  
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯╽تم حذف ⤶ ❨ قائمة المنع • المحظورين • المكتومين • االادامن • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
--     Source dev-yousef     --
...
if #admins ~= 0 then adminst = 'االادامن • ' else adminst = '' end
...
--     Source dev-yousef     --
if DevAbs:get(ZOLARS..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفلة' else mute_text = 'مفتوحة'end
if DevAbs:get(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفلة' else mute_photo = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفلة' else mute_video = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفلة' else mute_gifs = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفلة' else mute_music = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفلة' else mute_in = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفلة' else mute_voice = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفلة' else mute_edit = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفلة' else mute_links = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفلة' else lock_pin = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفلة' else lock_sticker = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفلة' else lock_tgservice = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفلة' else lock_wp = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفلة' else lock_htag = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفلة' else lock_tag = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفلة' else lock_location = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفلة' else lock_contact = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفلة' else lock_english = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفلة' else lock_arabic = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفلة' else lock_forward = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Document'..msg.chat_id_) then lock_file = 'مقفلة' else lock_file = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفلة' else markdown = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفلة' else lock_spam = 'مفتوحة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAbs:get(ZOLARS.."Abs:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفلة' else send_welcome = 'مفتوحة' end
...
if DevAbs:get(ZOLARS..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحة' else lock_taf = 'مقفلة' end
if DevAbs:get(ZOLARS..'Abs:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفلة' else lock_farsi = 'مفتوحة' end
...
if text == "الروابط" then if DevAbs:get(ZOLARS..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفلة' else mute_links = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الروابط ⤶ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(ZOLARS..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽المعرف ⤶ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "المتحركة" or text == "الملصقات المتحركة" then if DevAbs:get(ZOLARS..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽المتحركة ⤶ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(ZOLARS..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الملصقات ⤶ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الصور" then if DevAbs:get(ZOLARS..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الصور ⤶ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(ZOLARS..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الفيديو ⤶ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الالدردشة" then if DevAbs:get(ZOLARS..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفلة' else mute_text = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الالدردشة ⤶ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الاغاني" then if DevAbs:get(ZOLARS..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الاغاني ⤶ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(ZOLARS..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الجهات ⤶ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الاشعارات" then if DevAbs:get(ZOLARS..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الاشعارات ⤶ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "المنشورات" then if DevAbs:get(ZOLARS..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽المنشورات ⤶ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الشبكات" then if DevAbs:get(ZOLARS..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الشبكات ⤶ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "المواقع" then if DevAbs:get(ZOLARS..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽المواقع ⤶ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "العربية" then if DevAbs:get(ZOLARS..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽العربية ⤶ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(ZOLARS..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحة' end local ZOLARSTEAM = "\n" .."✯╽الانكليزيه ⤶ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
...
if text == "الطائفية" then if DevAbs:get(ZOLARS..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحة' else lock_taf = 'مقفلة' end local ZOLARSTEAM = "\n" .."✯╽الطائفية ⤶ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, ZOLARSTEAM, 1, 'md') end
end
--     Source dev-yousef     --
...
--     Source dev-yousef     --
if text and text:match("^معلومات المجموعة$") and ChCheck(msg) or text and text:match("^عدد الاعضاء$") and ChCheck(msg) or text and text:match("^عدد القروب$") and ChCheck(msg) or text and text:match("^عدد االادامن$") and ChCheck(msg) or text and text:match("^عدد المحظورين$") and ChCheck(msg) then
local Muted = DevAbs:scard(ZOLARS.."Abs:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽المجموعة ⤶ ❨ '..dp.title_..' ❩\n✯╽الايدي ⤶ ❨ '..msg.chat_id_..' ❩\n✯╽عدد الاعضاء ⤶ ❨ *'..data.member_count_..'* ❩\n✯╽عدد االادامن ⤶ ❨ *'..data.administrator_count_..'* ❩\n✯╽عدد المطرودين ⤶ ❨ *'..data.kicked_count_..'* ❩\n✯╽عدد المكتومين ⤶ ❨ *'..Muted..'* ❩\n✯╽عدد رسائل المجموعة ⤶ ❨ *'..(msg.id_/2097152/0.5)..'* ❩\n• • • • • • 𝙄𝘽𝙊 • • • • • •\n', 1, 'md') 
end,nil)
end,nil)
end
--     Source dev-yousef     --
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './ZOLARS.lua', '✯╽نسخة ملف سورس ايبو',dl_cb, nil)
end end
--     Source dev-yousef     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر االادامن",callback_data="/HelpList2:"..msg.sender_user_id_},{text="اوامر الحماية",callback_data="/HelpList1:"..msg.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..msg.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..msg.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..msg.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..msg.sender_user_id_}},{{text="• اخفاء الأوامر •",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
✯╽تعطيل • تفعيل ⤶  التحقق
✯╽تعطيل • تفعيل ⤶  امسح
✯╽تفعيل الحذف التلقائي - تعطيل الحذف التلقائي
• • • • • • 𝙄𝘽𝙊 • • • • • •
✯╽[𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍](https://t.me/HH_418)
]]
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽جاري تحديث سورس ايبو', 1, 'md') 
os.execute('rm -rf ZOLARS.lua') 
os.execute('wget https://raw.githubusercontent.com/IBOIBO99/ZOLARS/master/ZOLARS.lua') 
dofile('ZOLARS.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/IBOIBO99/ZOLARSFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/IBOIBO99/ZOLARSFiles/master/ZOLARSFiles/"..FileName)
if Res == 200 then
...
--     Source dev-yousef     --
if text and text:match("^ضع كليشة المطور$") or text and text:match("^وضع كليشة المطور$") or text and text:match("^تغيير كليشة المطور$") then
if not SecondSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽للمطور الاساسي فقط ', 1, 'md')
else
...
if text and text:match("^مسح كليشة المطور$") or text and text:match("^حذف كليشة المطور$") then
if not SecondSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽للمطور الاساسي فقط ', 1, 'md')
else
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯╽Channel ↬ [@HH_418]', 1, 'md')    
end 
--     Source dev-yousef     --
